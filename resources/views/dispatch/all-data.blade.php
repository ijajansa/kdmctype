...
<!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				<h6 class="mb-0 text-uppercase" style="display:inline-block;">Order In Dispatch</h6>
				<hr/>
						...
						<div class="table-responsive">
							<table id="example" class="table table-hover table-striped table-bordered" style="width:100%">
								...
								<tbody>
									...
									<tr>
										<td>{{++$key}}</td>
										<td>{{$production->accepted_date}}</td>
										...
										<td>
											...
											@elseif($production->order->status==1)
											...
											@else
											<div class="badge rounded-pill text-success bg-light-success p-2 text-uppercase px-3"><i class='bx bxs-circle align-middle me-1'></i>Accepted</div>
											@endif
										</td>
										
										<td>
											<a href="{{config('app.baseURL')}}/checking/checking-view/{{$production->id}}"><button type="button" class="btn btn-danger btn-sm  px-4">View Dispatch Details</button></a>
										</td>
									</tr>
									@endforeach
								</tbody>
