							...
							<div class="card-body p-5">
								...
								<form class="row g-3" method="POST" action="{{config('app.baseURL')}}/production/edit/{{$order->order_id}}">
									...
									<div class="col-md-6">
										...
										<input type="text" name="name" class="form-control" id="inputFirstName" value="{{$order->customer_name}}" required readonly>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" id="inputLastName2" name="core_size" value="{{$order->core_size}}" required readonly>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" id="inputPassword" name="material" value="{{$order->material}}" required  readonly>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<input type="text" name="job_card" class="form-control" id="inputState3">
									</div>
									<div class="col-12">
