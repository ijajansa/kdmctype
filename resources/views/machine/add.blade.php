						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">Add Machine</h5>
								</div>
								<hr>
								<form method="POST" action="{{config('app.baseURL')}}/machine/add" class="row g-3">
									@csrf
									<div class="col-12">
										<label for="inputFirstName" class="form-label">Machine ID</label>
										<input type="text" name="machine_id"  class="form-control" id="inputFirstName" required>
									</div>
									
									<div class="col-12">
										<label for="inputFirstName" class="form-label">Machine Name</label>
										<input type="text" name="machine_name"  class="form-control" id="inputFirstName" required>
									</div>
